...
export const BottomGradient = () => {
  return (
    <>
      ...
      <span className='via-indigo-500 absolute inset-x-10 -bottom-px mx-auto block h-px w-1/2 bg-gradient-to-r from-transparent to-transparent opacity-0 blur-sm transition duration-500 group-hover/btn:opacity-100' />
    </>
  )
}
